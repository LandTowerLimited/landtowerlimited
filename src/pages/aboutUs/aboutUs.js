      ...
      <div className="w-full">
        ...
        <div className="lg:flex md:flex pt-6 px-6">
          ...
          <div className="lg:w-1/4 md:w-1/4 lg:ml-3 md:ml-3">
            <img
              src={LTLAboutImage4}
              alt="About Land Tower Limited 4"
              title="About Land Tower Limited 4"
            />
          </div>
        </div>
        <div className="flex justify-center items-center">
          <div className="px-6 lg:w-3/5 md:lg:w-3/5 ">
            ...
            <div className="px-2 mb-20 mt-6 font-graphikRegular text-lg text-grey-400 text-center">
              ...
              <p className="pb-6">
                Our operational and service offering caters for a wide spectrum
                of construction needs, exquisite finishing and furnishing in
                both private and public sectors. Our success can be attributed
                to our competent team of qualified professionals coupled with
                our state of the art equipment and technologies.
              </p>
              <p className="pb-6">
              ...
              <p className="pb-6">
                ...
                construction company in the globe by consistently adding value
                to our clients through innovation, foresight, professionalism
                and technology.
              </p>
              <p className="pb-6">
                Our Mission is to deliver top-quality building structures by
                combining efficient contemporary architectural design, streak
                successful sequential building project methodologies,
                innovation, value engineering, standard MEP works, exquisite
