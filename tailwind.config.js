...
module.exports = {
  ...
  theme: {
    extend: {
      fontFamily: {
        georgiaBold: "'GeorgiaBold', serif",
        georgiaRegular: "'GeorgiaRegular', serif",
      ...
      colors: {
        "landTower-background-color": "#FCFCFC",
        "landTower-gold-color": "#FABC68",
        "landTower-gold2-color": "#ECCEA8",
        "landTower-gold3-color": "#EAA94B",
      },
      borderWidth: {
        is0point5: "0.5px",
      },
